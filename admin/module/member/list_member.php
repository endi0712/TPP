                                     ...
                                     <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a href="<?php echo $admin_url ;?>module/member/aksi_hapus.php?id_user=<?php  echo $mem['id_user'];?>" onClick ="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
                                            </div>
                                        </td>
                                     </tr>
                                <?php  } ?>
